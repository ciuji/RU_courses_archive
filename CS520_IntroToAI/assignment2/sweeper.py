...
# =============================================================================
        ...
        if(self.target==0):
            ...
            self.rightrate=(np.count_nonzero(self.object==-1)+self.score)/float(np.count_nonzero(self.object==-1))
...
#print('current:\n',sp.current)
mg.drawboard(sp.current)
print("times of touching a mine:",res)
print("identified mines / total mines:",sp.rightrate)
